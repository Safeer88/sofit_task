...
public class AdapterClassPayment extends RecyclerView.Adapter<AdapterClassPayment.ViewHoldeer>{
    ArrayList<ModelClassImage> word;
    Context context;

    public AdapterClassPayment(Context mContext, ArrayList<ModelClassImage> words){
    ...
    public ViewHoldeer onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        View view = inflater.inflate(R.layout.frg_home_lst_items_payment,viewGroup,false);
    ...
    public  class ViewHoldeer extends RecyclerView.ViewHolder{
       ...
       ImageView imageView;
        public ViewHoldeer(@NonNull View itemView) {
            super(itemView);
            textView = (TextView) itemView.findViewById(R.id.frg_home_list_txv_payment);
            imageView = (ImageView) itemView.findViewById(R.id.frg_home_list_payment_img);
        }
    }
}
